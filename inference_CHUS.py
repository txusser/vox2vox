...
dat_csv = "C:/Users/jesus/OneDrive/FIDIS/Neuro/Quantidopa_v2/Datscan_CHUS_data.csv"
source_dir = "D:/Work/DAT_SPECT/DATSCAN_CHUS_100subjects/DATSCAN"
...
for img_index, img_row in orig_df.iterrows():
    ...
    patient_path = join(source_dir,patient_id)
    if exists(patient_path):
        normalization = 'None'
        nonorm_path = join(patient_path,'ndatscan.nii')
        dlnorm_path = join(patient_path,'dldatscan.nii')
